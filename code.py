...
class PlacementBackend:
    def __init__(self):
        ...
        # Features and target
        X = self.df[["CGPA", "DSA", "Aptitude", "Certifications", "Internships", "Projects"]]
        y = self.df["Placed"]
    ...
    def predict_result(self, cgpa, dsa, aptitude, certifications, internships, projects):
        # Make prediction
        result = self.model.predict([[cgpa, dsa, aptitude, certifications, internships, projects]])
